...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('website', '0003_alter_news_created_at_alter_news_published_at'),
    ...
    operations = [
        migrations.AlterField(
            model_name='news',
            name='published_at',
            field=models.DateTimeField(default=datetime.datetime(2024, 2, 10, 12, 21, 44, 793569), verbose_name='Опубликовать в'),
        ),
